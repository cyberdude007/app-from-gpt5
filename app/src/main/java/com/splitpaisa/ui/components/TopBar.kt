    ...
    TopAppBar(
        title = {
            Row(
                ...
                Surface(color = Color(0xFF2BB39A), shape = MaterialTheme.shapes.medium, modifier = Modifier.size(32.dp)) {}
        ...
        actions = {
            Row(
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text("Plain mode", fontSize = 13.sp, modifier = Modifier.padding(end = 6.dp))
